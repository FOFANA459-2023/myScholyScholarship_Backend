...
# Additional CORS settings for mobile and production
...
DATABASES = {
    "default": {
        ...
        "DISABLE_SERVER_SIDE_CURSORS": os.environ.get("DB_POOL_MODE", "").lower()
        == "transaction",
    },
...
# WhiteNoise compressed static file storage for deployment
