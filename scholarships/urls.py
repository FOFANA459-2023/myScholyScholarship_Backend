...
urlpatterns = [
    ...
    path('admin/scholarships/<int:pk>/delete/', views.delete_scholarship, name='delete-scholarship'),

    # Admin User Management
    path('admins/', views.admin_users, name='admin-users'),  # GET, POST
    path('admins/<int:user_id>/', views.delete_admin_user, name='delete-admin-user'),  # DELETE
]
